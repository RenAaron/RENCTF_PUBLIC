  ...
  const placeCell = (rowIndex, cellIndex, team, moves) => {
    if(moves > 0){
      ...
      Swal.fire({
        ...
        confirmButtonText: "Ӯ̨¦ߍȜЧݞՏגùНΪߕō۫щЏ*"
      });
    }
  ...
  return (
    <main style={{ width: '100%', height: '100%', display: "flex",  alignItems: "center", flexDirection: 'column'}}>
      ...
      <div style={{height: '10%', justifyContent: "center", width: '100%', alignItems: "center", display: "flex", marginTop: '30px', justifyContent: 'center'}}>
        ...
        <h2 style={{color: '#ff1c77'}}> ( 9 - 7 - 24 )</h2>
      </div>
      ...
      <div style={{width: '100%', height: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: '20px', paddingBottom: '20px' }}>
        <div style={{width: '35%', height: '100%', display: "flex", backgroundColor: 'black',border: '1px dashed #ffffff', flexDirection: 'column'}}>
          ...
          <div style ={{flexDirection: 'column'}}><Leaderboard/></div>
        </div>
        <div style={{width: '50%', height: '100%', justifyContent: 'center', alignItems: 'center', display: "flex", flexDirection: 'column'}}>
          ...
          <div style={{ width: '90%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '5px'}}>
            <t style={{fontSize: '24px', color:'#00aeff', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              BLUE TEAM: <t style={{color:'white'}}>&nbsp;{BlueScore}</t>
              &nbsp;
              {RedScore <= BlueScore && (
                <img src="/icons/CBlue.gif" alt="Pixel Art" class="pixel-art" width={23} height={23}/>
              )}
            </t>

            <t style={{fontSize: '24px', color:'#ff2200', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              RED TEAM: <t style={{color:'white'}}>&nbsp;{RedScore}</t>
              &nbsp;
              {RedScore >= BlueScore && (
                <img src="/icons/CRed.gif" alt="Pixel Art" class="pixel-art" width={23} height={23}/>
              )}
            </t>
          </div>
          ...
          <div style={{ width: '70%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '5px'}}>
            ...
            {team == "Red" && (
              <t style={{fontSize: '20px', color:'#ff2200', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              YOUR MOVES: &nbsp;<t style={{color: 'white'}}>{moves}</t>
              &nbsp;
              <img src="/icons/Red.gif" alt="Pixel Art" class="pixel-art" width={20} height={20}/>

              </t>
            )}

            {team == "Blue" && (
              <t style={{fontSize: '20px', color:'#00aeff', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              YOUR MOVES: &nbsp;<t style={{color: 'white'}}>{moves}</t>
              &nbsp;
              <img src="/icons/Blue.gif" alt="Pixel Art" class="pixel-art" width={20} height={20}/>
      ...
      <div style={{width: '100%', height: '40%', display: 'flex'}}>
        <div style={{width: '33.33%', display: "flex",  alignItems: "center", flexDirection: 'column', paddingTop: '10px'}}> 
          ...
          <div style = {{width: '100%', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
            ...
            <img src="/icons/EEas.gif" alt="Pixel Art" class="pixel-art-button" width={30} height= 'auto'/>
          </div>

          <div style ={{height: '20%', width: '90%', textAlign: 'center', paddingTop: '10px'}}>
            This is an <t style = {{color: '#88ff00'}}>EASY</t> challenge! Submitting the correct answer to the CTF in the text box above grants you <t style = {{color: '#88ff00'}}>+1 move</t> on the board! 
          </div>
        ...
        <div style={{width: '33.33%', display: "flex",  alignItems: "center", flexDirection: 'column', paddingTop: '10px'}}> 
          ...
          <div style = {{width: '100%', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
            ...
            <img src="/icons/EMed.gif" alt="Pixel Art" class="pixel-art-button" width={30} height= 'auto'/>
          </div>
          
          
          <div style ={{height: '20%', width: '90%', textAlign: 'center', paddingTop: '10px'}}>
            This is a <t style = {{color: '#ff8c00'}}>MEDIUM</t> challenge! Submitting the correct answer to the CTF in the text box above grants you <t style = {{color: '#ff8c00'}}>+2 moves</t> on the board! 
          </div>
        ...
        <div style={{width: '33.33%', display: "flex",  alignItems: "center", flexDirection: 'column', paddingTop: '10px'}}> 
          ...
          <div style = {{width: '100%', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
            ...
            <img src="/icons/EHard.gif" alt="Pixel Art" class="pixel-art-button" width={30} height= 'auto'/>
          </div>

          <div style ={{height: '20%', width: '90%', textAlign: 'center', paddingTop: '10px'}}>
            This is a <t style = {{color: '#ff0037'}}>HARD</t> challenge! Submitting the correct answer to the CTF in the text box above grants you <t style = {{color: '#ff0037'}}> <br></br> +3 moves</t> on the board! 
          </div>
        </div>
      </div>
